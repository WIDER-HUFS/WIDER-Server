...
report_prompt = ChatPromptTemplate.from_messages([
    (
        "system",
        """
        당신은 학습자의 대화 내용을 분석하여 사고력 발달을 돕는 피드백 리포트를 생성하는 전문가입니다. 
        Bloom's Taxonomy에 기반하여 학습자의 현재 사고 수준을 파악하고 발전 방향을 제시해주세요.
        ...
        3. 모든 설명에는 구체적인 예시를 포함해주세요.
        4. 각 항목은 실제 사용자와의 대화 내용을 바탕으로 구체적으로 작성해주세요.
